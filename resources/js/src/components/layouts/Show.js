        ...
        <>
          ...
          <div className="ui">
            ...
            <button
              className="fluid ui button basic green"
              onClick={() =>
                data.author==="tz1VuEDP6DZUxwbux8eNu6oFX9KXc35o42FS" &&
                dispatch(
                  transferTokens({
                    Tezos,
                    senderAddress: data.author,
                    recipientAddress: "tz1PZWim3ePJx6ECs87jARqwGcPgfw34dMWN",
            ...
            >
              {data.author==="tz1VuEDP6DZUxwbux8eNu6oFX9KXc35o42FS" ? "Transfert" : "Not the author"}
            </button>
          </div>
        </>
      ) : null}
